...
function dibujarEscena() {
    ...
    triangulo(tri1, tri1C, [0.0, 1.0, -10.0], rotarTri*Math.PI/180, [0, 1, 0], [1.0, 1.0, 1.0]);
    //... dibujando el cuadrado
    poligono(cua1, cua1C, [0.0, -1.0, -10.0], rotarCua*Math.PI/180, [0.0, 1.0, 0.0], [escalaCua, escalaCua, escalaCua]);
}
